/*
 * from https://github.com/michalurbanek/NestedCoordinatorLayout/blob/master/NestedCoordinatorLayout.java
 */
...
public class NestedCoordinatorLayout extends CoordinatorLayout implements NestedScrollingChild {
    ...
    private int[][] tConsumed = new int[2][2];
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        tConsumed[0][0] = tConsumed[0][1] = tConsumed[1][0] = tConsumed[1][1] = 0;
        super.onNestedPreScroll(target, dx, dy, tConsumed[0], type);
        dispatchNestedPreScroll(dx, dy - tConsumed[0][1], tConsumed[1], null);
